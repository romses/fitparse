...
class FitFile(object):
    def __init__(self, fileish, check_crc=True, data_processor=None):
        ...
        self._file.seek(0,2) # Move to EoF
        self._file_size = self._file.tell() # Get End_Position
        self._file.seek(0,0) # "Rewind" file
    ...
    def select_fit_subfile(self,pos=0):
        ...
        if self._files[pos]:
            ...
            self._file.seek(self._files[0],0) 
        self._parse_file_header()
        
    def get_fit_subfiles(self):
    ...
    def _parse_file_header(self):
        ...
        return header_size+data_size+2 #        Header + Data + CRC
